...
<div id="content">
  <div class="inner" style="min-height: 700px;">
     <div class="row">
        ...
        <div class="col-lg-6">
            <br>
            <button class="pull-right btn btn-success btn-small" data-toggle="modal"  data-target="#newTask">Create New Task</button>
        </div>
        @endif
    </div>
    <hr>
                ...
                <div class="body">
                    @if($isAllocated)
                        <div class="alert alert-danger" role="alert">
                            You did not hire any Person for your project. Please contact to HR Manager.
                        </div>
                    @endif
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" id="register__Requests">
                                ...
                                <tbody>
                                    ...
                                    <tr class="click-able" style=" cursor: pointer;" data-href="{{ url('/client/tasksDetails/'.$task->id) }}">
                                        ...
                                        <td>
                                            {{ $task->allocateTo->ManagerDetail->first_name }}
                                        </td>
                                        <td>@php echo " ".DayandTimeFormat($task->start); @endphp </td>
                                    </tr>                                            
                                    @endforeach
                                </tbody>
                            </table>
